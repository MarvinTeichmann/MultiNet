...
bool eval(string path,Mail* mail){

  // set some global parameters
  initGlobals();

  // ground truth and result directories
  string gt_dir         = "/home/mifs/mttt2/github/UnitedVision/submodules/KittiObjective/val_gt";
...
int32_t main (int32_t argc,char *argv[]) {
  ...
  if (argc!=2 && argc!=4) {
    cout << "Usage: ./eval_detection path_to_prediction" << endl;
    return 1;
  }
  ...
  // run evaluation
  if (eval(path_to_prediction,mail)) {
